      ...
      <div class="table-responsive">
        <table class="table table-striped jambo_table bulk_action">
          ...
          <?php
            ...
            $calon = new Karyawan();
            $stmt = $calon->runQuery("SELECT tb_karyawan.no_ktp, no_NIK, nama_depan, nama_belakang, jenis_kelamin, tb_karyawan.email, nomor_hp, tb_login_karyawan.joining_date, tb_apply_pekerjaan.kd_pekerjaan, tb_jenis_pekerjaan.nama_pekerjaan FROM tb_karyawan
